...
req.open("POST", "http://localhost:8888/OpenClassrooms/javascript-web/chapitre_10/javascript-web-srv/post_form.php");
...
ajaxPost("http://localhost:8888/OpenClassrooms/javascript-web/chapitre_10/javascript-web-srv/post_form.php", commande, function(response){
...
form.addEventListener("submit", function(e){
  ...
  ajaxPost("http://localhost:8888/OpenClassrooms/javascript-web/chapitre_10/javascript-web-srv/post_form.php", data, function() {});
});*/
...
ajaxPost("http://localhost:8888/OpenClassrooms/javascript-web/chapitre_10/javascript-web-srv/post_json.php", film,
    function (reponse) {
