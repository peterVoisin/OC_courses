...
// Même evenement mais avec une fonction anonyme
//var boutonElt = document.getElementById("bouton");
// Ajout d'un gestionnaire pour l'événement click
...
document.getElementById("bouton").addEventListener("click", function (e) {
  console.log("Evénement : " + e.type + ", texte de le cible : " + e.target.textContent);
});

// Gestion de l'appui sur un etouche du clavier produisant un caractère
...
// Gestion de l'appui et du relâchement d'un touche du clavier
...
// Fonctionne que si on interagi avec la page avant !!
...
// Gestion de clic sur le document
